      ...
      <Router>
        ...
        <main className="App">
          ...
          <HeaderBar 
            ...
            giveColor={this.state.isNightModeEnabled === true ? nightMode && console.log("Night Mode Enabled") : dayMode && console.log("Day Mode Enabled")}
            giveStyle={ this.state.isNightModeEnabled === true ? nightMode : null }
          />
